...
const projects = [
  ...
  },
  {
    ...
    githublink:
      "https://github.com/Nabeel-99/Springboot_football_manager_CRUD.git",
  ...
  {
    image: "chronicle1.png",
    title: "Beautiful Landing Page",
    description: `Beautiful landing page created with Framer motion, React JS, Tailwind CSS`,
    githublink: "https://github.com/Nabeel-99/framer-motion-tutorials.git",
    images: [
      "chronicle2.png",
      "chronicle3.png",
      "chronicle4.png",
...
const setProjectCards = (arr = projects) => {
  projectTile.innerHTML = arr
    .map(({ image, description, title, githublink, images }, index) => {
      return `
                        ...
                        <div class="container">
                            <div class="slide">
                                ${images
                                  .map(
                                    (image) =>
                                      `<div class="item" style="background-image: url('../Images/${image}')"></div>`
                                  )
                                  .join("")}
                            </div>
                            <div class="button">
  ...
  document.querySelectorAll(".next").forEach((button) => {
    button.addEventListener("click", function () {
      ...
      document
        .querySelector(`#slider-${sliderId} .slide`)
        .appendChild(items[0]);
    });
  });
