...
const ProfileCard = () => {
  ...
  return (
    <motion.div
      ...
      className="border relative overflow-hidden rounded-[40px] flex flex-col gap-4 backdrop-blur-md dark:bg-[#121212] border-[#dadada] dark:border-[#1f1f1f] p-10 w-full xl:w-[700px] 2xl:w-full "
    >
      <div
